...
namespace C_.PlayerController
{
    public class PCombo3 : IState
    {
        ...
        public PCombo3(PlayerFsm manager)
        {
        ...
        private void JudgeCombo2()
        {
            ...
            {
                if (_comboStep == 1 && fire2Input && _endPoint) // 当前第一段攻击，右键触发 Combo 2
                {
                    _comboStep++;
                ...
                else if (_comboStep == 2 && fire1Input && _endPoint) // 当前第二段攻击，左键触发 Combo 3
                {
                    _comboStep++;
                    _canPlayNextCombo = true;
                    _endPoint = false;
                ...
                else if (_comboStep == 3 && fire2Input && leftShiftInput && _endPoint) // 当前第三段攻击，shift+右键触发 Combo 4
                {
                    _comboStep++;
                    _canPlayNextCombo = true;
                    _endPoint = false;
        ...
        private void PlayComboAnimation()
        {
            ...
            {
                case 1:
                    _paramenter.animator.Play("Combo_03_1");
                    break;
                case 2:
                    _paramenter.animator.Play("Combo_03_2");
                    break;
                case 3:
                    _paramenter.animator.Play("Combo_03_3");
                    break;
                case 4:
                    _paramenter.animator.Play("Combo_03_4");
                    break;
            }
        }
    }
