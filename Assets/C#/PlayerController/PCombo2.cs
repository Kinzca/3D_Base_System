...
namespace C_.PlayerController
{
    public class PCombo2 : IState
    {
        ...
        public PCombo2(PlayerFsm manager)
        {
        ...
        private void JudgeCombo2()
        {
            ...
            var spaceInput = Input.GetButton("Duck");
            ...
            if (stateInfo.normalizedTime >= 0.5f && stateInfo.normalizedTime < 0.9f)
            {
                ...
                else if (_comboStep == 3 && fire2Input && spaceInput && _endPoint) // 当前第三段攻击，空格+右键触发 Combo 4
                {
                    _comboStep++;
                    _canPlayNextCombo = true;
                    _endPoint = false;
        ...
        private void PlayComboAnimation()
        {
            ...
            {
                case 1:
                    _paramenter.animator.Play("Combo_02_1");
                    break;
                case 2:
                    _paramenter.animator.Play("Combo_02_2");
                    break;
                case 3:
                    _paramenter.animator.Play("Combo_02_3");
                    break;
                case 4:
                    _paramenter.animator.Play("Combo_02_4");
                    break;
            }
        }
    }
